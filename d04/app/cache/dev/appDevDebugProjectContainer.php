...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/E02Bundle/Entity'))), 'E02Bundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('E02Bundle' => 'E02Bundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_5bd6ffcae53cb81030c60409d4c95b37ec8ff36047d799001d9302c8c7aa0a7e');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/E01Bundle/Resources/views'), 'E01');
        $instance->addPath(($this->targetDirs[3].'/src/E02Bundle/Resources/views'), 'E02');
        $instance->addPath(($this->targetDirs[3].'/src/E03Bundle/Resources/views'), 'E03');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('60b20999ab8df8.86278906')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'E00Bundle' => 'E00Bundle\\E00Bundle',
                'E01Bundle' => 'E01Bundle\\E01Bundle',
                'E02Bundle' => 'E02Bundle\\E02Bundle',
                'E03Bundle' => 'E03Bundle\\E03Bundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'E00Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/E00Bundle'),
                    'namespace' => 'E00Bundle',
                ),
                'E01Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/E01Bundle'),
                    'namespace' => 'E01Bundle',
                ),
                'E02Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/E02Bundle'),
                    'namespace' => 'E02Bundle',
                ),
                'E03Bundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/E03Bundle'),
                    'namespace' => 'E03Bundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
